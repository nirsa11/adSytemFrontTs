...
export const RolePage: React.FC<RolePageProps> = ({ setRole, role }) => {
  return (
    <Container className="d-flex flex-column justify-content-center align-items-start gap-3">
      <h1 id="main-title" className="display-5 fs-2">
        שלום וברוכים הבאים למערכת הפרסום של PieChat!
      </h1>
      ...
      <Dropdown>
        ...
        <Dropdown.Menu>
          {Object.keys(UserRoleEnumSelection).map((role) => {
            return (
